...
-(id)initWithFrame:(CGRect)frame title:(NSString*)title titleColor:(UIColor*)titleColor font:(UIFont*)font delegate:(id)delegate groupId:(NSString *)groupId{
    if (self = [super init]) {
        ...
        [self setImage:[UIImage imageNamed:@"VoteUnselect"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"VoteSelect"] forState:UIControlStateSelected];
